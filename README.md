...
OpenEBS v0.4.0, provides integration into Kubernetes Clusters. Please follow [OpenEBS documentation](https://readthedocs.org/), if you are using Kubernetes.
...
*For further info, checkout https://readthedocs.org/ or join the slack# http://slack.openebs.io*
